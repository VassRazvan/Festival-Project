...
set CLASSPATH=%APP_HOME%\lib\Ui-1.0-SNAPSHOT.jar;%APP_HOME%\lib\Networking-1.0-SNAPSHOT.jar;%APP_HOME%\lib\Service-1.0-SNAPSHOT.jar;%APP_HOME%\lib\Repository-1.0-SNAPSHOT.jar;%APP_HOME%\lib\Domain-1.0-SNAPSHOT.jar;%APP_HOME%\lib\javafx-fxml-17-win.jar;%APP_HOME%\lib\javafx-controls-17-win.jar;%APP_HOME%\lib\javafx-controls-17.jar;%APP_HOME%\lib\javafx-graphics-17-win.jar;%APP_HOME%\lib\javafx-graphics-17.jar;%APP_HOME%\lib\javafx-base-17-win.jar;%APP_HOME%\lib\javafx-base-17.jar;%APP_HOME%\lib\log4j-core-2.14.0.jar;%APP_HOME%\lib\log4j-api-2.14.0.jar;%APP_HOME%\lib\sqlite-jdbc-3.36.0.3.jar


@rem Execute Ui
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %UI_OPTS%  -classpath "%CLASSPATH%" StartRpcClient %*
